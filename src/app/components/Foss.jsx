...
const OpenSourceOrganizations = () => {
  ...
  return (
    <div className="min-h-screen bg-black mx-auto max-w-[81vw] text-orange-200 pb-8 px-4">
         <section className="mb-16 ">

         <h1 className="text-left text-5xl w-screen font-extrabold text-orange-600 uppercase md:ml-36 border-b border-orange-700 pb-4 mb-10">
         Why FOSS?
      </h1>
      ...
      <h1 className="text-left text-5xl font-extrabold text-orange-600 uppercase w-screen border-b border-orange-700 pb-4 mb-10">
        Prominent Foss Organisations
      </h1>
